...
public class UranusView extends View{
	Space space;
	PlanetFactory factory;

	public UranusView(Pane root, Model model, Scene scene) {
		super(root, model, scene);
		space = new Space(800, 600, gc);
		factory = new PlanetFactory(310, 200, gc, "uranus.png");
		PlanetInterface planetInt = factory.createPlanet("uranus.png");
	...
	public void changePlanet(ActionEvent event) {
        new NeptuneView(root, model, scene);
