...
public class EarthView extends View{
	...
	public EarthView(Pane root, Model model, Scene scene) {
		super(root, model, scene);
		space = new Space(800, 600, gc);
		factory = new PlanetFactory(310, 200, gc, "earth.png");
		PlanetInterface planetInt = factory.createPlanet("earth.png");
