...
public class VenusView extends View{
	Space space;
	PlanetFactory factory;

	public VenusView(Pane root, Model model, Scene scene) {
		super(root, model, scene);
		space = new Space(800, 600, gc);
		factory = new PlanetFactory(310, 200, gc, "venus.png");
		PlanetInterface planetInt = factory.createPlanet("venus.png");
	...
	public void changePlanet(ActionEvent event) {
        new EarthView(root, model, scene);
