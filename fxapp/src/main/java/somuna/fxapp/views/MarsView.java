...
public class MarsView extends View{
	...
	public MarsView(Pane root, Model model, Scene scene) {
		super(root, model, scene);
		space = new Space(800, 600, gc);
		factory = new PlanetFactory(310, 200, gc, "mars.png");
		PlanetInterface planetInt = factory.createPlanet("mars.png");
	...
	public void changePlanet(ActionEvent event) {
        new JupiterView(root, model, scene);
